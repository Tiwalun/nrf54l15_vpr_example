...
#[doc = "This event is unused, but the PPIB provides the PUBLISH event to connect RECEIVE \\[n\\]
event.\n\nValue on reset: 0"]
...
#[doc = "Field `EVENTS_RECEIVE` reader - This event is unused, but the PPIB provides the PUBLISH event to connect RECEIVE \\[n\\]
event."]
...
#[doc = "Field `EVENTS_RECEIVE` writer - This event is unused, but the PPIB provides the PUBLISH event to connect RECEIVE \\[n\\]
event."]

...
impl W {
    #[doc = "Bit 0 - Write '1' to disable interrupt for event READY"]
    #[inline(always)]
    pub fn ready(&mut self) -> ReadyW<Intenclr00Spec> {
        ReadyW::new(self, 0)
    }
    #[doc = "Bit 1 - Write '1' to disable interrupt for event TXREADY"]
    #[inline(always)]
    pub fn txready(&mut self) -> TxreadyW<Intenclr00Spec> {
        TxreadyW::new(self, 1)
    }
    #[doc = "Bit 2 - Write '1' to disable interrupt for event RXREADY"]
    #[inline(always)]
    pub fn rxready(&mut self) -> RxreadyW<Intenclr00Spec> {
        RxreadyW::new(self, 2)
    }
    #[doc = "Bit 3 - Write '1' to disable interrupt for event ADDRESS"]
    #[inline(always)]
    pub fn address(&mut self) -> AddressW<Intenclr00Spec> {
        AddressW::new(self, 3)
    }
    #[doc = "Bit 4 - Write '1' to disable interrupt for event FRAMESTART"]
    #[inline(always)]
    pub fn framestart(&mut self) -> FramestartW<Intenclr00Spec> {
        FramestartW::new(self, 4)
    }
    #[doc = "Bit 5 - Write '1' to disable interrupt for event PAYLOAD"]
    #[inline(always)]
    pub fn payload(&mut self) -> PayloadW<Intenclr00Spec> {
        PayloadW::new(self, 5)
    }
    #[doc = "Bit 6 - Write '1' to disable interrupt for event END"]
    #[inline(always)]
    pub fn end(&mut self) -> EndW<Intenclr00Spec> {
        EndW::new(self, 6)
    }
    #[doc = "Bit 7 - Write '1' to disable interrupt for event PHYEND"]
    #[inline(always)]
    pub fn phyend(&mut self) -> PhyendW<Intenclr00Spec> {
        PhyendW::new(self, 7)
    }
    #[doc = "Bit 8 - Write '1' to disable interrupt for event DISABLED"]
    #[inline(always)]
    pub fn disabled(&mut self) -> DisabledW<Intenclr00Spec> {
        DisabledW::new(self, 8)
    }
    #[doc = "Bit 9 - Write '1' to disable interrupt for event DEVMATCH"]
    #[inline(always)]
    pub fn devmatch(&mut self) -> DevmatchW<Intenclr00Spec> {
        DevmatchW::new(self, 9)
    }
    #[doc = "Bit 10 - Write '1' to disable interrupt for event DEVMISS"]
    #[inline(always)]
    pub fn devmiss(&mut self) -> DevmissW<Intenclr00Spec> {
        DevmissW::new(self, 10)
    }
    #[doc = "Bit 11 - Write '1' to disable interrupt for event CRCOK"]
    #[inline(always)]
    pub fn crcok(&mut self) -> CrcokW<Intenclr00Spec> {
        CrcokW::new(self, 11)
    }
    #[doc = "Bit 12 - Write '1' to disable interrupt for event CRCERROR"]
    #[inline(always)]
    pub fn crcerror(&mut self) -> CrcerrorW<Intenclr00Spec> {
        CrcerrorW::new(self, 12)
    }
    #[doc = "Bit 14 - Write '1' to disable interrupt for event BCMATCH"]
    #[inline(always)]
    pub fn bcmatch(&mut self) -> BcmatchW<Intenclr00Spec> {
        BcmatchW::new(self, 14)
    }
    #[doc = "Bit 15 - Write '1' to disable interrupt for event EDEND"]
    #[inline(always)]
    pub fn edend(&mut self) -> EdendW<Intenclr00Spec> {
        EdendW::new(self, 15)
    }
    #[doc = "Bit 16 - Write '1' to disable interrupt for event EDSTOPPED"]
    #[inline(always)]
    pub fn edstopped(&mut self) -> EdstoppedW<Intenclr00Spec> {
        EdstoppedW::new(self, 16)
    }
    #[doc = "Bit 17 - Write '1' to disable interrupt for event CCAIDLE"]
    #[inline(always)]
    pub fn ccaidle(&mut self) -> CcaidleW<Intenclr00Spec> {
        CcaidleW::new(self, 17)
    }
    #[doc = "Bit 18 - Write '1' to disable interrupt for event CCABUSY"]
    #[inline(always)]
    pub fn ccabusy(&mut self) -> CcabusyW<Intenclr00Spec> {
        CcabusyW::new(self, 18)
    }
    #[doc = "Bit 19 - Write '1' to disable interrupt for event CCASTOPPED"]
    #[inline(always)]
    pub fn ccastopped(&mut self) -> CcastoppedW<Intenclr00Spec> {
        CcastoppedW::new(self, 19)
    }
    #[doc = "Bit 20 - Write '1' to disable interrupt for event RATEBOOST"]
    #[inline(always)]
    pub fn rateboost(&mut self) -> RateboostW<Intenclr00Spec> {
        RateboostW::new(self, 20)
    }
    #[doc = "Bit 21 - Write '1' to disable interrupt for event MHRMATCH"]
    #[inline(always)]
    pub fn mhrmatch(&mut self) -> MhrmatchW<Intenclr00Spec> {
        MhrmatchW::new(self, 21)
    }
    #[doc = "Bit 22 - Write '1' to disable interrupt for event SYNC"]
    #[inline(always)]
    pub fn sync(&mut self) -> SyncW<Intenclr00Spec> {
        SyncW::new(self, 22)
    }
    #[doc = "Bit 23 - Write '1' to disable interrupt for event CTEPRESENT"]
    #[inline(always)]
    pub fn ctepresent(&mut self) -> CtepresentW<Intenclr00Spec> {

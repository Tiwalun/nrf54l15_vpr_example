...
#[doc = "Field `CHIDX` reader - DPPI channel that event MATCH\\[n\\]
will publish to"]
pub type ChidxR = crate::FieldReader;
#[doc = "Field `CHIDX` writer - DPPI channel that event MATCH\\[n\\]
will publish to"]
...
impl R {
    #[doc = "Bits 0:7 - DPPI channel that event MATCH\\[n\\]
will publish to"]
    #[inline(always)]
...
will publish to"]
    #[inline(always)]
    pub fn chidx(&mut self) -> ChidxW<MatchSpec> {
        ChidxW::new(self, 0)
    }
    #[doc = "Bit 31"]
    #[inline(always)]
    pub fn en(&mut self) -> EnW<MatchSpec> {
        EnW::new(self, 31)
    }
}

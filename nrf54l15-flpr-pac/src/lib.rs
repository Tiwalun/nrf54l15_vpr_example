#![doc = "Peripheral access API for NRF54L15_FLPR microcontrollers (generated using svd2rust v0.33.4 ( ))\n\nYou can find an overview of the generated API [here].\n\nAPI features to be included in the [next]
...
#[doc(hidden)]
#[no_mangle]
pub static __EXTERNAL_INTERRUPTS: [Vector; 271] = [
    Vector {
        _handler: VPRCLIC_0,
    },
    Vector {
...
pub struct VprclicNs {
    _marker: PhantomData<*const ()>,
}
unsafe impl Send for VprclicNs {}
impl VprclicNs {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const vprclic_ns::RegisterBlock = 0xf000_0000 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
    pub const fn ptr() -> *const vprclic_ns::RegisterBlock {
        Self::PTR
    }
    #[doc = r" Steal an instance of this peripheral"]
    #[doc = r""]
...
impl Deref for VprclicNs {
    type Target = vprclic_ns::RegisterBlock;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        unsafe { &*Self::PTR }
    }
